...
@section('canonical_url', url('/latest'))
        ...
        <section class="hot-movies">
            ...
            <div class="text-center">
                <ul class="page-numbers">
                    ...
                    @if($hasPrevPage)
                        <li>
                            <a class="prev page-numbers" href="{{ url('/moi-cap-nhat') }}?page={{ $currentPage - 1 }}">
                                « Trước
                            </a>
                        </li>
                    @endif
                    ...
                    @if($start > 1)
                        <li>
                            <a class="page-numbers" href="{{ url('/moi-cap-nhat') }}?page=1">1</a>
                        </li>
                        @if($start > 2)
                    ...
                    @for($i = $start; $i <= $end; $i++)
                        <li>
                            ...
                            @else
                                <a class="page-numbers" href="{{ url('/moi-cap-nhat') }}?page={{ $i }}">{{ $i }}</a>
                            @endif
                        </li>
                    @endfor
                    ...
                    @if($end < $totalPages)
                        ...
                        @endif
                        <li>
                            <a class="page-numbers" href="{{ url('/moi-cap-nhat') }}?page={{ $totalPages }}">{{ $totalPages }}</a>
                        </li>
                    @endif
                    ...
                    @if($hasNextPage)
                        <li>
                            <a class="next page-numbers" href="{{ url('/moi-cap-nhat') }}?page={{ $currentPage + 1 }}">
                                Tiếp »
                            </a>
                        </li>
                    @endif
