                    ...
                    <div class="col-xs-12">
                        <form id="search-form-pc" name="halimForm" role="search" method="GET">
                            <div class="form-group">
                                <div class="input-group col-xs-12"> <input id="search" type="text" name="s" value="" class="form-control" data-toggle="tooltip" data-placement="bottom" data-original-title="Nhấn Enter để tìm kiếm" placeholder="Tìm kiếm..." autocomplete="off" required=""> <i class="fa-solid fa-spinner hidden animate-spin"></i></div>
                            </div>
                        </form>
